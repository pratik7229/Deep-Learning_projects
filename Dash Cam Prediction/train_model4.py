...
def augment_two_frames(frames, label):
    """Applies augmentation to both frames using Keras Sequential Augmentation."""
...
###############################################################################
# 6) FINAL MODEL: MobileNetV2 + Transformer + BiLSTM + Soft Attention
###############################################################################
...
model.save("final_optimized_model3.keras")
